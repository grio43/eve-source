#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\carbon\common\stdlib\ssl.py
import textwrap
import re
import sys
import os
...
class SSLContext(_SSLContext):
    ...
    def _wrap_socket(self, *args, **kwargs):
        ret = super(SSLContext, self)._wrap_socket(*args, **kwargs)
        return ret
