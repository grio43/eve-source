#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\industry\activities\research_time.py
import industry
...
class ResearchTime(industry.Activity):
    ...
    def job_max_runs(self, job):
        return min(industry.Activity.job_max_runs(self, job), (industry.MAX_TIME_EFFICIENCY - job.blueprint.timeEfficiency) / industry.STEP_TIME_EFFICIENCY)
