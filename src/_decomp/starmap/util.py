#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\starmap\util.py
...
class SolarSystemMapInfo(object):
    __slots__ = ('regionID', 'constellationID', 'star', 'center', 'scaledCenter', 'factionID', 'neighbours', 'planetCountByType', 'planetItemIDs')
