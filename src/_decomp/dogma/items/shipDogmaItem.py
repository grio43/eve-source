#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\dogma\items\shipDogmaItem.py
import weakref
from collections import defaultdict
from itertools import izip
from locationDogmaItem import LocationDogmaItem
import inventorycommon.const as invconst
from inventorycommon.util import IsShipFittingFlag, IsFighterTubeFlag
import dogma.const as dgmconst
import blue
from dogma.attributes.heatAttribute import CalculateHeat
...
class ShipDogmaItem(LocationDogmaItem):
    ...
    def ValidFittingFlag(self, flagID):
        if flagID == invconst.flagDroneBay or IsFighterTubeFlag(flagID):
            return True
        return IsShipFittingFlag(flagID)
