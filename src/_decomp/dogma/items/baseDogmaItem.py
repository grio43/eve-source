#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\dogma\items\baseDogmaItem.py
...
class BaseDogmaItem(SlimDogmaItem):
    ...
    def Load(self, item, instanceRow):
        ...
        for attrID, value in self.dogmaLocation.GetAttributesForItem(item.itemID, typeID).iteritems():
    ...
    @TimedFunction('BaseDogmaItem::_FlushEffects')
