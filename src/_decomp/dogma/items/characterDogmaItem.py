#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\dogma\items\characterDogmaItem.py
...
class CharacterDogmaItem(FittableDogmaItem):
    ...
    def OnItemLoaded(self):
        if not self.dogmaLocation.HasBrainData(self.itemID):
    ...
    def HandleLocationChange(self, oldShipID):
        ...
        try:
            ...
            super(CharacterDogmaItem, self).HandleLocationChange(oldShipID)
