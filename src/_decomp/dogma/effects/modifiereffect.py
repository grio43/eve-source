#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\dogma\effects\modifiereffect.py
...
class ModifierEffect(Effect):
    ...
    def __init__(self, effectInfo, modifiers, side_effects = None):
        ...
        self.__modifier_domain_other__ = IsPassiveEffect(effectInfo) and any((m.IsOtherModifier() for m in modifiers))
