#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\dogma\dogmaLogging.py
...
def DecodeID(someID):
    ...
    if isInvItem:
        ...
        return descr
    if dogma_data.is_attribute(someID):
        descr = "dgmattrib '{}'".format(dogma_data.get_attribute_name(someID))
        return descr
