#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\sentry_sdk\integrations\pyramid.py
...
class PyramidIntegration(Integration):
    ...
    def setup_once():
        ...
        def sentry_patched_wsgi_call(self, environ, start_response):
            ...
            return SentryWsgiMiddleware(lambda *a, **kw: old_wsgi_call(self, *a, **kw))(environ, start_response)
...
def _capture_exception(exc_info, **kwargs):
    ...
    if hub.get_integration(PyramidIntegration) is None:
        return
    event, hint = event_from_exception(exc_info, client_options=hub.client.options, mechanism={'type': 'pyramid',
     'handled': False})
