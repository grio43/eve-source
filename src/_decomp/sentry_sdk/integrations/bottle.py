#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\sentry_sdk\integrations\bottle.py
        ...
        def patched_make_callback(self, *args, **kwargs):
            ...
            def wrapped_callback(*args, **kwargs):
                ...
                def capture_exception(exception):
                    event, hint = event_from_exception(exception, client_options=hub.client.options, mechanism={'type': 'bottle',
                     'handled': False})
