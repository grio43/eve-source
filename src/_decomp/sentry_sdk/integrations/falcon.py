#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\sentry_sdk\integrations\falcon.py
...
def _patch_handle_exception():
    ...
    def sentry_patched_handle_exception(self, *args):
        ...
        if integration is not None and not _is_falcon_http_error(ex):
            event, hint = event_from_exception(ex, client_options=hub.client.options, mechanism={'type': 'falcon',
             'handled': False})
