#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\projectdiscovery\client\projects\subcellular\taskimages.py
import logging
import math
import os
import blue
...
class TaskImage(Container):
    ...
    def setup_layout(self):
        self.transmitting_container = Container(name='transmitting_container', parent=self, align=uiconst.CENTER, width=self.width, height=70, top=-15, opacity=0, state=uiconst.UI_DISABLED)
        self._create_processing_label()
        self.expandTopContainer = Container(name='expandTopContainer', parent=self.transmitting_container, width=364, height=8, align=uiconst.TOTOP)
        self.expandTop = Sprite(name='expandTop', parent=self.expandTopContainer, texturePath='res:/UI/Texture/classes/ProjectDiscovery/expandTop.png', width=174, height=5, align=uiconst.CENTERTOP)
        self.original_expand_width = self.expandTop.width
        self.expandBracketTop = Sprite(name='expandbracketsTop', parent=self.expandTopContainer, texturePath='res:/UI/Texture/classes/ProjectDiscovery/expandBrackets.png', width=364, height=3, align=uiconst.CENTERTOP, top=5)
        self.original_expand_bracket_width = self.expandBracketTop.width
        self.expandBottomContainer = Transform(name='expandBottomContainer', parent=self.transmitting_container, width=364, height=8, align=uiconst.TOBOTTOM, rotation=math.pi)
        self.expandBracketBot = Sprite(name='expandbracketBot', parent=self.expandBottomContainer, texturePath='res:/UI/Texture/classes/ProjectDiscovery/expandBrackets.png', width=364, height=3, align=uiconst.CENTERTOP, top=5)
        self.expandBot = Sprite(name='expandBot', parent=self.expandBottomContainer, texturePath='res:/UI/Texture/classes/ProjectDiscovery/expandTop.png', width=174, height=5, align=uiconst.CENTERBOTTOM, top=3)
        self.expandGradient = Sprite(parent=self.transmitting_container, align=uiconst.CENTER, width=364, height=64, texturePath='res:/UI/Texture/classes/ProjectDiscovery/expandGradient.png')
        self.colorFilterContainer = Container(name='colorFilterContainer', parent=self, align=uiconst.TOBOTTOM_PROP, height=0.065)
        self.colorFilterButtonsContainer = Container(name='colorFilterButtonsContainer', parent=self.colorFilterContainer, align=uiconst.CENTERTOP, width=120, height=24)
        self.colorCube = ButtonIcon(name='colorCube', parent=self.colorFilterButtonsContainer, align=uiconst.TOLEFT, width=30, height=24, opacity=2, texturePath='res:/UI/Texture/classes/ProjectDiscovery/colorFilterCube.png', func=self.toggle_all_channels)
        self.colorCube.icon.SetSize(30, 24)
        self.colorCubeSelectedSprite = Sprite(name='selectedFilter', parent=self.colorFilterButtonsContainer, width=30, height=24, align=uiconst.TOPLEFT, texturePath='res:/UI/Texture/classes/ProjectDiscovery/colorFilterSelection.png')
        self.colorSwatchRed = ButtonIcon(parent=self.colorFilterButtonsContainer, align=uiconst.TOLEFT, width=30, height=24, texturePath='res:/UI/Texture/classes/ProjectDiscovery/colorFilterSwatch_R.png', func=self.toggle_red_channel)
        self.colorSwatchRed.icon.SetSize(30, 24)
        self.redSelectedSprite = Sprite(name='selectedFilter', parent=self.colorFilterButtonsContainer, width=30, height=24, align=uiconst.TOPLEFT, texturePath='res:/UI/Texture/classes/ProjectDiscovery/colorFilterSelection.png', left=30, opacity=0)
        self.colorSwatchGreen = ButtonIcon(name='colorSwatchGreen', parent=self.colorFilterButtonsContainer, align=uiconst.TOLEFT, width=30, height=24, texturePath='res:/UI/Texture/classes/ProjectDiscovery/colorFilterSwatch_G.png', func=self.toggle_green_channel)
        self.colorSwatchGreen.icon.SetSize(30, 24)
        self.greenSelectedSprite = Sprite(name='selectedFilter', parent=self.colorFilterButtonsContainer, width=30, height=24, align=uiconst.TOPLEFT, texturePath='res:/UI/Texture/classes/ProjectDiscovery/colorFilterSelection.png', left=60, opacity=0)
        self.colorSwatchBlue = ButtonIcon(parent=self.colorFilterButtonsContainer, align=uiconst.TOLEFT, width=30, height=24, iconSize=30, texturePath='res:/UI/Texture/classes/ProjectDiscovery/colorFilterSwatch_B.png', func=self.toggle_blue_channel)
        self.colorSwatchBlue.icon.SetSize(30, 24)
        self.blueSelectedSprite = Sprite(name='selectedFilter', parent=self.colorFilterButtonsContainer, width=30, height=24, align=uiconst.TOPLEFT, texturePath='res:/UI/Texture/classes/ProjectDiscovery/colorFilterSelection.png', left=90, opacity=0)
        self.colorFilterBack = Sprite(parent=self.colorFilterContainer, align=uiconst.CENTERTOP, width=187, height=32, texturePath='res:/UI/Texture/classes/ProjectDiscovery/colorFilterBack.png')
        self.images_container = Container(name='ImagesContainer', parent=self, align=uiconst.TOPLEFT_PROP, clipChildren=True, width=self.ORIGINAL_WIDTH, height=self.ORIGINAL_HEIGHT)
        self.image_locked_sprite = Sprite(name='lockImage', parent=self.images_container, texturePath='res:/UI/Texture/classes/ProjectDiscovery/magnifyLocked.png', width=54, height=64, align=uiconst.CENTER, opacity=0, state=uiconst.UI_DISABLED)
        self.image_unlocked_sprite = Sprite(name='unlockImage', parent=self.images_container, texturePath='res:/UI/Texture/classes/ProjectDiscovery/magnifyUnlocked.png', width=108, height=64, align=uiconst.CENTER, opacity=0, state=uiconst.UI_DISABLED)
        self.image_container = Container(name='mainImageContainer', parent=self.images_container, align=uiconst.TOALL, clipChildren=True)
        self.image_frame = Frame(name='imageFrame', bgParent=self.images_container, texturePath='res:/UI/Texture/classes/ProjectDiscovery/SampleBack.png', cornerSize=20, color=(1.0, 1.0, 1.0, 0.5))
        ...
        self.mini_map_container = Container(name='miniMapContainer', parent=self.images_container, align=uiconst.BOTTOMRIGHT, width=100, height=100, top=12, left=12)
        self.mini_map_container_frame = Frame(name='zoomContainerFrame', parent=self.mini_map_container, state=uiconst.UI_HIDDEN, color=(1.0, 1.0, 1.0, 0.5))
        self.mini_map_frame_container = Container(name='miniMapFrameContainer', parent=self.mini_map_container, align=uiconst.TOPLEFT, width=30, height=30)
        self.mini_map_frame = Frame(name='zoomFrame', parent=self.mini_map_frame_container, state=uiconst.UI_HIDDEN, color=(1.0, 1.0, 1.0, 0.5))
        self.mini_map_image_sprite = Sprite(name='miniMapSprite', parent=self.mini_map_container, width=100, height=100)
        self.zoom_image_container = Container(name='zoomContainer', parent=self.images_container, align=uiconst.TOALL, clipChildren=True, pos=(10, 10, 10, 10))
        self.zoom_image_sprite = Sprite(name='zoomSprite', parent=self.zoom_image_container, align=uiconst.TOALL, opacity=0, pos=(0, 0, -1200, -1200))
        self.error_message = eveLabel.Label(parent=self.images_container, align=uiconst.CENTER, text=localization.GetByLabel('UI/ProjectDiscovery/NoImageErrorLabel'), opacity=0)

    def _create_processing_label(self):
        self.label_container = Container(parent=self.transmitting_container, height=PROCESSING_LABEL_HEIGHT, align=uiconst.CENTER, fontsize=PROCESSING_LABEL_FONT_SIZE)
    ...
    def reset_image(self):
        if hasattr(self, 'image_sprite'):
            ...
            self.image_frame.SetRGBA(1, 1, 1, 0.5)
            self.show_loading_wheel()
    ...
    def expand_screen(self):
        ...
        self.image_frame.SetRGBA(0.498, 0.627, 0.74, 0.5)
...
class SubCellularSprite(Sprite):
