#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\projectdiscovery\client\projects\subcellular\tutorial.py
import copy
import logging
import math
import random
...
class Tutorial(Container):
    ...
    def setup_layout(self):
        ...
        self.explanation_icon = Sprite(parent=self.left_main_container, align=uiconst.TOPRIGHT, width=54, height=54, top=35, left=15, texturePath='res:/UI/Texture/WindowIcons/attention.png', state=uiconst.UI_HIDDEN)
        ...
        self.submit_button = Button(name='submitButton', parent=self.submit_button_container, align=uiconst.CENTER, label=localization.GetByLabel('UI/ProjectDiscovery/SubmitButtonLabel'), fontsize=18, fixedwidth=170, fixedheight=30, func=lambda x: self.submit_training_solution())
        ...
        self.task_id = eveLabel.Label(parent=self, align=uiconst.BOTTOMRIGHT, height=20, opacity=0.5, left=10)
        self.refresh_task_button = Button(name='refreshTaskButton', parent=self.category_container, align=uiconst.CENTER, func=lambda x: self.reset_task(), idx=0, label='Refresh Task', fixedwidth=120, fixedheight=30, state=uiconst.UI_HIDDEN)
