#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\projectdiscovery\client\const.py
import os
import localization
...
class Sounds:
    AnalysisDonePlay = 'project_discovery_analysis_done_play'
    AnalysisWindowMovePlay = 'project_discovery_analysis_window_move_play'
    CategorySelectPlay = 'project_discovery_category_select_play'
    ColorSelectPlay = 'project_discovery_color_select_play'
    MainImageLoadPlay = 'project_discovery_main_image_calculation_loop_play'
    MainImageLoadStop = 'project_discovery_main_image_calculation_loop_stop'
    MainImageLoopPlay = 'project_discovery_main_image_loop_play'
    MainImageLoopStop = 'project_discovery_main_image_loop_stop'
    MainImageOpenPlay = 'project_discovery_main_image_open_play'
    ProcessingPlay = 'project_discovery_analysis_calculation_loop_play'
    ProcessingStop = 'project_discovery_analysis_calculation_loop_stop'
    RewardsWindowClosePlay = 'project_discovery_analysis_window_close_play'
    RewardsWindowLoopPlay = 'project_discovery_analysis_window_loop_play'
    RewardsWindowLoopStop = 'project_discovery_analysis_window_loop_stop'
    RewardsWindowOpenPlay = 'project_discovery_analysis_window_open_play'
...
class Colors(object):
    GREEN = (0.15294, 0.88627, 0.51764, 1)
    RED = (0.87843, 0.24313, 0.15686, 1)
    YELLOW = (0.85882, 0.85882, 0.17254, 1)
    BLUE = (0, 0.721, 0.78, 1)


class BgColors(object):
    GREEN = (0.15294, 0.88627, 0.51764, 0.25)
    RED = (0.87843, 0.24313, 0.15686, 0.25)
    YELLOW = (0.85882, 0.85882, 0.17254, 0.25)
    BLUE = (0, 0.721, 0.78, 0.25)
