#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\projectdiscovery\client\util\tutorialtooltips.py
...
class BasicTutorialTooltip(TutorialTooltip):
    ...
    def LoadTooltip(self, header, description, on_continue, on_quit):
        ...
        self.AddCell(ButtonIcon(texturePath='res:/UI/Texture/icons/38_16_220.png', iconSize=16, width=16, height=16, func=on_quit), margin=(0, 0, 0, 0))
        ...
        self.AddCell(Button(label=localization.GetByLabel('UI/ProjectDiscovery/TutorialContinueButtonLabel'), align=uiconst.CENTER, func=lambda _: on_continue()), colSpan=self.columns)
