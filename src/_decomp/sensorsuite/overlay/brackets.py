#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\sensorsuite\overlay\brackets.py
from carbon.common.lib import telemetry
from carbon.common.script.util.format import FmtDist
from carbon.common.script.util.timerstuff import AutoTimer
import carbonui.const as uiconst
from carbonui.primitives.bracket import Bracket
from eve.client.script.ui.inflight.bracketsAndTargets.bracketVarious import IsTargetingOrSettingSecondPoint
...
class SensorSuiteBracket(Bracket):
    ...
    def OnClick(self, *args):
        if IsTargetingOrSettingSecondPoint():
            uicore.layer.inflight.SetMouseDownAndDoMouseUp()
            return
        sm.GetService('stateSvc').SetState(self.data.ballID, selected, 1)
    ...
    def OnMouseDown(self, *args):
        GetMenuService().TryExpandActionMenu(None, self, siteData=self.data)
