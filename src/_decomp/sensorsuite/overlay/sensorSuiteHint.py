#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\sensorsuite\overlay\sensorSuiteHint.py
...
def OpenProbeScanner(*_):
    uicore.cmd.GetCommandAndExecute('ToggleProbeScanner')
