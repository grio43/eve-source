#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\sensorsuite\overlay\signatures.py
import math
...
class SignatureSiteData(ScannableSiteData):
    ...
    def __init__(self, siteID, position, targetID, difficulty, dungeonID, archetypeID, dungeonNameID = None, deviation = None, signalStrength = 0.0):
        ScannableSiteData.__init__(self, siteID, position, targetID, difficulty, dungeonID, archetypeID, dungeonNameID, factionID=None, scanStrengthAttribute=None)
...
class SignatureHandler(ScannableSiteHandler):
    ...
    def GetSiteData(self, siteID, siteInfo):
        return SignatureSiteData(siteID, siteInfo.position, siteInfo.targetID, siteInfo.difficulty, siteInfo.dungeonID, siteInfo.archetypeID, deviation=siteInfo.deviation)
