#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\sensorsuite\overlay\siteconst.py
...
SITE_COLOR_SHARED_BOOKMARK = Color(41, 181, 191)
...
SITE_ICON_SHARED_BOOKMARK = 'res:/UI/Texture/classes/Bookmarks/sharedBookmarkSensorOverlay.png'
SITE_OUTER_TEXTURE_SHARED_BOOKMARK = ('res:/UI/Texture/classes/SensorSuite/bracket_bookmark_corp_1.png', 'res:/UI/Texture/classes/SensorSuite/bracket_bookmark_corp_2.png', 'res:/UI/Texture/classes/SensorSuite/bracket_bookmark_corp_3.png', 'res:/UI/Texture/classes/SensorSuite/bracket_bookmark_corp_4.png')
...
SITE_SHARED_BOOKMARK = KeyVal(color=SITE_COLOR_SHARED_BOOKMARK, outerTextures=SITE_OUTER_TEXTURE_SHARED_BOOKMARK, icon=SITE_ICON_SHARED_BOOKMARK)
