#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\sensorsuite\overlay\staticsites.py
...
class StaticSiteData(SiteData):
    ...
    def GetMenu(self):
        return GetMenuService().CelestialMenu(self.siteID)
...
class StaticSiteHandler(SiteHandler):
    ...
    def GetSiteData(self, siteID, staticSiteInfo):
        return StaticSiteData(siteID, staticSiteInfo.position, staticSiteInfo.dungeonNameID, staticSiteInfo.factionID)
