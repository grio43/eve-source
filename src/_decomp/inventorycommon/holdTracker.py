#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\inventorycommon\holdTracker.py
import logging
...
class HoldTracker(object):
    ...
    def BlinkAndUpdateIfChanged(self):
        try:
            ...
            log.warning('BlinkAndUpdateIfChanged Failed', exc_info=1)
