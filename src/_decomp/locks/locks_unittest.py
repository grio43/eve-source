#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\locks\locks_unittest.py
import unittest
import random
import stackless
from contextlib import contextmanager
from locks import *
from testsuites.testcases import ServerTestCase
...
class TestLock(TestLockCommon, TestLockOnly, ServerTestCase):
    lockType = Lock
...
class TestRLock(TestLockCommon, TestLockOnly, ServerTestCase):
    lockType = RLock
...
class TestCondition(TestLockCommon, ServerTestCase):
    lockType = Condition
