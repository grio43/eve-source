#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\sovDashboard\claimedSystems.py
...
class ClaimedSystemEntry(DashboardEntry):
    ...
    def GetMenu(self):
        return GetMenuService().CelestialMenu(self.node.solarSystemID)
...
class ClaimedSystemsDashboard(SovDashboard):
    ...
    def ReloadDashboard(self):
        ...
        for solarsystemID, structures in structuresPerSolarsystem.iteritems():
            ...
            entry = GetFromClass(self.entryClass, entryData)
