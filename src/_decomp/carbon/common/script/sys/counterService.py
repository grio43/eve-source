#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\carbon\common\script\sys\counterService.py
import types
...
from carbon.common.script.sys.serviceConst import ROLE_ADMIN, ROLE_PROGRAMMER, ROLE_SERVICE
from carbon.common.script.util.format import GetTimeParts
from stringutil import strx

def CurrentTimeString():
    year, month, weekday, day, hour, minute, second, ms = GetTimeParts(blue.os.GetWallclockTime())
