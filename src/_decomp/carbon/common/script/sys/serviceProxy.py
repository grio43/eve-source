#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\carbon\common\script\sys\serviceProxy.py
import zlib
import types
import inspect
import random
import uthread
from cluster import NODES, NODE_ALL, NODE_ANY, NODE_ALL_SERVER, NODE_ALL_PROXY, NODE_ANY_SERVER, NODE_ANY_PROXY
from cluster import SERVICE_MODS, SERVICE_MOD_DEFAULT
...
class ServiceProxy(object):
    ...
    def _WrapServiceMethod(self, methodName, method, resolve):
        ...
        elif isinstance(resolveArgument, int) and resolveArgument in NODES:
        ...
        def wrapped(self, *args, **kwargs):
            ...
            if resolveArgument == NODE_ALL:
                ...
                serviceMod = SERVICE_MODS.get(resolveConst, SERVICE_MOD_DEFAULT)
