#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\carbon\client\script\graphics\debugRenderClient.py
import trinity
import blue
import yaml
import log
from carbon.common.script.sys.service import Service
from carbon.common.script.util import safeThread
...
class DebugRenderClient(Service, safeThread.SafeThread):
