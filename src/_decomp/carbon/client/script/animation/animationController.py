#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\carbon\client\script\animation\animationController.py
import log
...
class AnimationController(object):
    ...
    def __init__(self, avatar):
        self.animationNetwork = animparams.GetParamsPerAvatar(avatar)
        self.entityRef = None
