#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\eveclientqatools\misc.py
...
def CubeOfDeath(*args):
    ...
    buttonBox = Container(name='buttonBox', parent=wnd.GetChild('main'), align=uiconst.TOBOTTOM, pos=(0, 0, 0, 40))
    selectionBox = Container(name='selectionBox', parent=wnd.GetChild('main'), align=uiconst.TOALL, pos=(0, 0, 0, 0))
    testOptions = [('classic cube of death', 1),
     ...
     ('MinmatarCube', 6),
     ('Add More Here', 10)]
    testCombo = Combo(parent=selectionBox, name=u'testCombo', label=u'Test', align=uiconst.CENTER, pos=(0, 0, 200, 200), options=testOptions)
    whereCheckbox = Checkbox(parent=selectionBox, name=u'whereCheckbox', text=u'Stay where you are', align=uiconst.CENTERTOP, pos=(0, 0, 200, 200), checked=False)
    ...
    Button(parent=buttonBox, name=u'Spawn', label=u'Spawn', align=uiconst.CENTER, pos=(0, 0, 200, 200), func=Spawn)
