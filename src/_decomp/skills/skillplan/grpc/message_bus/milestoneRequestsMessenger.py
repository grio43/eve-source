#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\skills\skillplan\grpc\message_bus\milestoneRequestsMessenger.py
from eveProto.generated.eve_public.character.skill.plan.milestone_pb2 import GetAllRequest, CreateRequest, DeleteRequest
from eveProto.generated.eve_public.character.skill.plan.milestone_pb2 import GetAllResponse, CreateResponse, DeleteResponse
from skills.skillplan.grpc.message_bus.requestsMessenger import send_request

class SkillPlanMilestoneRequestsMessenger(object):
    public_gateway = None
