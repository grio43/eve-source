#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\common\script\dogma\effect.py
...
CombineModifiers = {dgmconst.dgmAssPreAssignment: lambda mod1, mod2: mod2,
 ...
 dgmconst.dgmAssPostPercentUnNerfed: lambda mod1, mod2: (100 + mod1) / 100.0 * ((100 + mod2) / 100.0) * 100 - 100}
