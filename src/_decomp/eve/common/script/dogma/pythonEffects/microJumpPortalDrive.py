#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\common\script\dogma\pythonEffects\microJumpPortalDrive.py
...
class BaseMicroJumpPortalDrive(Effect):
    ...
    __effectIDs__ = ['effectMicroJumpPortalDrive', 'effectMicroJumpPortalDriveCapital']
    effectIDList = None
