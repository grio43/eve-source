#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\common\script\dogma\pythonEffects\bastionMode.py
...
class BaseBastionMode(Effect):
    ...
    SKILL_MODIFIER_CHANGES_FOR_OWNER = [(dConst.dgmAssPostPercent,
      3324,
