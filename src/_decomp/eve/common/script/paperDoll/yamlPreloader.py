#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\common\script\paperDoll\yamlPreloader.py
import telemetry
import cStringIO
import weakref
import yaml
...
def LoadYamlFileNicely(pathToFile, enableCache = True):
    ...
    if blue.paths.exists(pathToFile):
        fileStream = blue.paths.GetFileContentsWithYield(pathToFile)
