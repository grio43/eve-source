#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\devtools\script\colors.py
import re
import blue
...
class ColorPicker(Window):
    ...
    def ApplyAttributes(self, attributes):
        ...
        self.greenColor = 0.0
        self.alphaColor = 1.0
        self.topContainer = Container(parent=self.sr.main, name='top container', pos=(0, 0, 0, 225), padding=(0, 0, 0, 0), align=uiconst.TOTOP)
        self.topLeftContainer = Container(parent=self.topContainer, name='top left', pos=(0, 0, 500, 0), padding=(10, 10, 10, 10), align=uiconst.TOLEFT)
        for i in xrange(40):
            self.mainColorDisplay = ColorTable(parent=self.topLeftContainer, name='main color display', pos=(0,
             0,
             0,
             +5), padding=(0, 0, 0, 0), align=uiconst.TOTOP, greyFactor=0.5 + (1.0 - i * (1.0 / 40.0)) * 0.5, onClicked=self.PickColorMain)

        self.topRightContainer = Container(parent=self.topContainer, name='top right', pos=(0, 0, 75, 0), padding=(0, 10, 10, 10), align=uiconst.TOLEFT)
        self.colorBarDisplay = []
        for i in xrange(40):
            self.colorBarDisplay.append(ColorBar(parent=self.topRightContainer, name='color bar', state=uiconst.UI_NORMAL, pos=(0,
             0,
             0,
        ...
        self.bottomContainer = Container(parent=self.sr.main, name='bottom container', pos=(0, 0, 0, 225), padding=(0, 0, 0, 0), align=uiconst.TOTOP)
        self.colorPreview = Container(parent=self.bottomContainer, name='color preview', pos=(10, 25, 175, 175), padding=(0, 0, 0, 0), align=uiconst.TOPLEFT)
        self.colorPreviewFill = Fill(parent=self.colorPreview, name='color preview fill', align=uiconst.TOALL, color=(self.redColor,
         self.greenColor,
         self.blueColor,
         self.alphaColor))
        self.colorValues = Container(parent=self.bottomContainer, name='color texts', pos=(225, 0, 300, 250), align=uiconst.TOPLEFT)
        eveLabel.Label(parent=self.colorValues, name='color text label', text='RGB', pos=(75, 0, 100, 25), align=uiconst.TOPLEFT)
        self.colorRed = SingleLineEditFloat(parent=self.colorValues, name='red color', setvalue=str(self.redColor), pos=(35, 25, 125, 50), align=uiconst.TOPLEFT, OnChange=self.UpdateFromEdit)
        eveLabel.Label(parent=self.colorValues, name='color text label', text='Red:', pos=(0, 25, 100, 50), align=uiconst.TOPLEFT)
        self.colorGreen = SingleLineEditFloat(parent=self.colorValues, name='green color', setvalue=str(self.greenColor), pos=(35, 65, 125, 50), align=uiconst.TOPLEFT, OnChange=self.UpdateFromEdit)
        eveLabel.Label(parent=self.colorValues, name='green color label', text='Green:', pos=(0, 65, 100, 50), align=uiconst.TOPLEFT)
        self.colorBlue = SingleLineEditFloat(parent=self.colorValues, name='blue color', setvalue=str(self.blueColor), pos=(35, 105, 125, 50), align=uiconst.TOPLEFT, OnChange=self.UpdateFromEdit)
        eveLabel.Label(parent=self.colorValues, name='blue color label', text='Blue:', pos=(0, 105, 100, 50), align=uiconst.TOPLEFT)
        self.colorAlpha = SingleLineEditFloat(parent=self.colorValues, name='alpha field', setvalue=str(self.alphaColor), pos=(35, 145, 125, 50), align=uiconst.TOPLEFT, OnChange=self.UpdateFromEdit)
        eveLabel.Label(parent=self.colorValues, name='alpha label', text='Alpha:', pos=(0, 145, 100, 50), align=uiconst.TOPLEFT)
        self.hexes = SingleLineEditText(parent=self.colorValues, name='hex field', pos=(35, 185, 125, 50), align=uiconst.TOPLEFT, OnChange=self.UpdateHexFromEdit)
        eveLabel.Label(parent=self.colorValues, name='hex label', text='Hex:', pos=(0, 185, 100, 50), align=uiconst.TOPLEFT)
        self.buttons = Container(parent=self.bottomContainer, name='color texts', pos=(400, 0, 300, 250), align=uiconst.TOPLEFT)
        self.rgbaButton = Button(parent=self.buttons, label='Copy RGBA', pos=(50, 75, 100, 50), align=uiconst.TOPLEFT, func=self.RgbaToClipBoard, args=())
        self.hexButton = Button(parent=self.buttons, label='Copy HEX', pos=(50, 125, 100, 50), align=uiconst.TOPLEFT, func=self.HexToClipBoard, args=())
...
class ColorBar(Container):
    ...
    def ApplyAttributes(self, attributes):
        ...
        self.fill = Fill(parent=self, align=uiconst.TOALL)
...
class ColorTable(Container):
    ...
    def ApplyAttributes(self, attributes):
        ...
        for i in xrange(100):
            currentVal = i / 100.0
            c = Container(parent=self, state=uiconst.UI_NORMAL, align=uiconst.TOLEFT, width=5)
            ...
            Fill(parent=c, align=uiconst.TOALL, color=(redFactor,
             greenFactor,
             blueFactor,
             1.0))
