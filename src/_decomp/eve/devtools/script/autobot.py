#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\devtools\script\autobot.py
...
class AutoBotService(Service):
    ...
    def _WorkerThread(self):
        try:
            ...
            self.Log('Security limits [%0.2f, %0.2f]' % (minSec, maxSec))
...
class AutoBotWindow(Window):
    ...
    def CreateSecurityFilter(self):
        ...
        self.minSecEdit = SingleLineEditFloat(parent=secCont, name='minSec', width=50, minValue=-1.0, maxValue=1.0, align=uiconst.TOLEFT, padTop=-3, setvalue='-1.0', decimalPlaces=2)
        EveLabelSmall(parent=secCont, text='Max Security', align=uiconst.TOLEFT, padding=4)
        self.maxSecEdit = SingleLineEditFloat(parent=secCont, name='maxSec', width=50, minValue=-1.0, maxValue=1.0, align=uiconst.TOLEFT, padTop=-3, setvalue='1.0', decimalPlaces=2)
    ...
    def CreateShipSelector(self):
        ...
        self.dnaEdit = SingleLineEditText(parent=cont, setvalue='DNA:593:2528:20197', align=uiconst.TOLEFT, width=200)
    ...
    def CreateSystemPass(self, passNumber):
        ...
        SingleLineEditInteger(parent=menuCont, minValue=1, maxValue=999, OnChange=lambda textValue: SetPassMinTime(textValue, passNumber), setvalue=passConfig['minTime'], align=uiconst.TOLEFT, width=50)
