#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\devtools\script\resmanmonitor.py
import blue
...
class ResManMonitor(Window):
    ...
    def ApplyAttributes(self, attributes):
        ...
        self.filterEdit = SingleLineEditText(parent=bottom, width=150, label='Filter:', OnReturn=self._OnRefresh)
        ...
        self.scroll = Scroll(parent=self.sr.main, id='resmanmonitorscroll', align=uiconst.TOALL, padding=(2, 2, 2, 12))
