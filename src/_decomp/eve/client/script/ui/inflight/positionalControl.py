#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\inflight\positionalControl.py
import blue
import uthread2
...
class PositionalControl:
    ...
    def StartMoveCommand(self):
        ...
        if shipSelected and not IsControllingStructure():
    ...
    def OnBallparkCall(self, functionName, callArgument, **kwargs):
        if functionName in ('WarpTo',) and callArgument[0] == session.shipid:
            self.AbortCommand()
