#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\inflight\squadrons\abilityIcon.py
...
class AbilityIcon(Container):
    ...
    def ApplyAttributes(self, attributes):
        ...
        self.abilityEffect = dogma_data.get_effect(effectID)
    ...
    def OnMouseEnter(self, *args):
        ...
        if requiredSafetyLevel is not None:
            ...
            self.safetyGlow.SetRGBA(*color.GetRGBA())
