#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\inflight\squadrons\fighterInvCont.py
...
from fighters import SquadronIsLight, SquadronIsSupport, SquadronIsHeavy
from fighters.client import GetFighterTubesForShip, GetLightSupportHeavySlotsForShip
...
class FighterInvCont(_InvContBase):
    __guid__ = 'invCont.FighterInvCont'
    __invControllerClass__ = None
    __notifyevents__ = _InvContBase.__notifyevents__ + ['ProcessActiveShipChanged']
    ...
    def _OnClose(self, *args):
        ...
        _InvContBase._OnClose(self, args)
