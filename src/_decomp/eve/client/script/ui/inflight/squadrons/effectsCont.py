#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\inflight\squadrons\effectsCont.py
import carbonui.const as uiconst
from carbonui.primitives.containerAutoSize import ContainerAutoSize
from eve.client.script.ui.control.eveIcon import Icon
from eve.common.script.mgt.buffBarConst import BUFF_SLOT_HINTS
...
class EffectsCont(ContainerAutoSize):
    ...
    def GetEwarHintCaption(self, jammingType):
        ewarHintPath = BUFF_SLOT_HINTS.get(jammingType, None)
