#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\inflight\spaceObjectIcon.py
import localization
import uthread
import telemetry
import blue
...
from eve.client.script.ui.shared.stateFlag import FlagIconWithState, GetIconFlagAndBackgroundFlag, GetExtraInfoForSlimItem, HasDockingRights
...
class SpaceObjectIcon(Container):
    ...
    def UpdateSpaceObjectFlagAndBackgroundColor(self, slimItem, ball):
        ...
        if updateItem:
            ...
            self.SetHostileIndicatorColor(_IsFleetMember(slimItem))
    ...
    def UpdateSpaceObjectState(self, slimItem, ball):
        ...
        updateItem = stateService.CheckIfUpdateItem(slimItem)
        if updateItem:
            fleetMember = _IsFleetMember(slimItem)
