#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\inflight\bracketsAndTargets\targetOnBracket.py
import math
import trinity
import localization
...
class ActiveTargetOnBracket(Container):
    ...
    def ApplyAttributes(self, attributes):
        ...
        self.rotatingArrows = Sprite(parent=self, name='rotatingArrows', pos=(0, 0, 120, 120), state=uiconst.UI_PICKCHILDREN, texturePath='res:/UI/Texture/classes/Target/spinCorners.png', color=(1.0, 1.0, 1.0, 0.2), align=uiconst.CENTER)
        self.selectedTargetCircle = Sprite(parent=self, name='selectedTargetCircle', pos=(0, 0, 80, 80), state=uiconst.UI_PICKCHILDREN, texturePath='res:/UI/Texture/classes/Target/selectedTargetedItem.png', color=(1.0, 1.0, 1.0, 0.15), align=uiconst.CENTER)
        self.RotateArrows()
...
class TargetLine(Fill):
    default_state = uiconst.UI_DISABLED
    default_color = (1.0, 1.0, 1.0, 1.0)
    default_align = uiconst.RELATIVE


class TargetOnBracket(Container):
    default_name = 'target'
    default_width = 94
    default_height = 94
    default_align = uiconst.CENTER
    ...
    def ApplyAttributes(self, attributes):
        ...
        self.circle = Sprite(parent=self, name='circle', pos=(0, 0, 96, 96), state=uiconst.UI_DISABLED, texturePath='res:/UI/Texture/classes/Target/outerCircle.png', color=(1.0, 1.0, 1.0, 0.1), align=uiconst.CENTER)
        self.lines = lines = Container(parent=self, name='lines', pos=(0, 0, 1, 1), align=uiconst.CENTER)
        ...
        self.leftTimer = Sprite(parent=self, name='leftTimer', pos=(0, 0, 76, 76), state=uiconst.UI_PICKCHILDREN, texturePath='res:/UI/Texture/classes/Target/timerLeft.png', textureSecondaryPath='res:/UI/Texture/classes/Target/timerLeft.png', color=(1.0, 1.0, 1.0, 0.4), align=uiconst.CENTER, blendMode=1, spriteEffect=trinity.TR2_SFX_MODULATE)
        self.leftTimer.display = False
        self.rightTimer = Sprite(parent=self, name='rightTimer', pos=(0, 0, 76, 76), state=uiconst.UI_PICKCHILDREN, texturePath='res:/UI/Texture/classes/Target/timerRight.png', textureSecondaryPath='res:/UI/Texture/classes/Target/timerRight.png', color=(1.0, 1.0, 1.0, 0.4), align=uiconst.CENTER, blendMode=1, spriteEffect=trinity.TR2_SFX_MODULATE)
        self.rightTimer.display = False
        self.targetingArrows = Sprite(parent=self, name='targetingArrows', pos=(0, 0, 120, 120), state=uiconst.UI_PICKCHILDREN, texturePath='res:/UI/Texture/classes/Target/spinCorners.png', color=(1.0, 1.0, 1.0, 0.6), align=uiconst.CENTER)
        self.targetingArrows.rotation = math.pi / 4
        self.targetingArrows.display = False
        t = eveLabel.EveLabelSmall(text='', parent=self, top=64, align=uiconst.CENTERTOP, state=uiconst.UI_DISABLED)
        self.lockingText = t
