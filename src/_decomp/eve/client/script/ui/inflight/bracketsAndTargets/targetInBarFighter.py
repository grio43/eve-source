#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\inflight\bracketsAndTargets\targetInBarFighter.py
import random
...
class TargetInBarFighter(TargetInBar):
    ...
    def ApplyAttributes(self, attributes):
        ...
        self.damageTimer = timerstuff.AutoTimer(random.randint(750, 1000), self.UpdateDamage)
