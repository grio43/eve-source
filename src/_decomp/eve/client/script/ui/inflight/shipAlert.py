#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\inflight\shipAlert.py
import math
import blue
...
class ShipAlertContainer(Container):
    ...
    def ApplyAttributes(self, attributes):
        ...
        self.alertText = None
        self.fullScreen = Container(name='shipAlerts', parent=uicore.layer.inflight, align=uiconst.TOALL, state=uiconst.UI_DISABLED)
        self.labelCont = Container(name='fakeTextCont', parent=self, align=uiconst.CENTER, state=uiconst.UI_DISABLED, width=400)
        self.warningLabelCont = Container(name='warningLabelCont', parent=self.labelCont, align=uiconst.TOBOTTOM, height=40, top=100)
        self.warningLabel = eveLabel.EveCaptionLarge(name='warningLabel', parent=self.warningLabelCont, align=uiconst.CENTER, bold=True, color=(1, 1, 1, 1.0), idx=0)
        self.warningLabel.uppercase = True
        self.warningLabel.opacity = 0.0
        self.exceptionLabel = eveLabel.Label(name='fakeException', parent=self.labelCont, align=uiconst.TOBOTTOM, fontsize=EVE_SMALL_FONTSIZE, color=(1, 0, 0, 0.4))
    ...
    def AddSideElements(self):
        ...
        cont = Container(name=name, parent=self.fullScreen, align=uiconst.TOALL)
        width = 1024
        height = 256
        Sprite(parent=cont, texturePath=texture, align=uiconst.CENTERTOP, height=height, width=width, color=(1, 0, 0, 1), rotation=math.pi, useSizeFromTexture=True)
        Sprite(parent=cont, texturePath=texture, align=uiconst.CENTERBOTTOM, height=height, width=width, color=(1, 0, 0, 1), rotation=0, useSizeFromTexture=True)
        cont.opacity = 0
        return cont
    ...
    def DoEnteringCapsuleAnimation(self):
        ...
        self.warningLabel.color = Color.RED
