#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\inflight\moduleEffectTimer.py
...
class ModuleEffectTimer(Container):
    ...
    def SetTimerOpacity(self, timerOpacity):
        ...
        if right and not right.destroyed:
            right.SetRGBA(*timerRGB)
        if left and not left.destroyed:
            left.SetRGBA(*timerRGB)
