#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\inflight\shipHud\heatGauges.py
import math
...
class HeatGauges(Container):
    ...
    def ConstructHeatGauge(self, deg):
        miniGauge = Transform(parent=self, name='heatGauge', pos=(-1, 40, 83, 12), align=uiconst.CENTER, rotation=math.radians(deg), idx=0)
    ...
    def UpdateLowHeatGauge(self, value, *args):
        rotation = math.radians(ANGLE_LOW_START - 56.0 * value)
    ...
    def UpdateMedHeatGauge(self, value, *args):
        rotation = math.radians(ANGLE_MED_START - 56.0 * value)
    ...
    def UpdateHiHeatGauge(self, value, *args):
        rotation = math.radians(ANGLE_HI_START - 56.0 * value)
