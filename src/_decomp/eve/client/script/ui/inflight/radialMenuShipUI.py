#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\inflight\radialMenuShipUI.py
...
class RadialMenuShipUI(RadialMenu):
    ...
    def AddOptionText(self):
        ...
        self.optionLabel = eveLabel.EveLabelLarge(parent=self.labelShadow, state=uiconst.UI_DISABLED, align=uiconst.CENTER, top=0, idx=0, bold=True)
    ...
    def OnMouseUpBlocker(self, button, *args):
        RadialMenu.OnMouseUp(self, button, *args)
