#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\tooltips\tooltipsWrappers.py
...
class TooltipDescriptionWrapper(TooltipBaseWrapper):

    def __init__(self, description, *args, **kwds):
        TooltipBaseWrapper.__init__(self, *args, **kwds)
        self._descriptionText = description
        self.tooltipPanel = None
