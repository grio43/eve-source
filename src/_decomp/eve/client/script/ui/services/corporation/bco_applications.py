#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\services\corporation\bco_applications.py
import locks
...
class ApplicationsO(BaseCorpObject):
    ...
    def OnCorporationApplicationChanged(self, corpID, applicantID, applicationID, newApplication):
        ...
        corpUISignals.on_corporation_application_changed(corpID, applicantID, applicationID, newApplication)
