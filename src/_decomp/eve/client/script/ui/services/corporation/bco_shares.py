#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\services\corporation\bco_shares.py
import uthread
from eve.client.script.ui.services.corporation.bco_base import BaseCorpObject

class SharesO(BaseCorpObject):
