#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\control\damageRing.py
import trinity
...
class DamageRing(container.Container):
    ...
    def ApplyAttributes(self, attributes):
        ...
        sprite.Sprite(name='icon', parent=self.content, pos=(0, 0, 70, 70), texturePath='res:/UI/Texture/classes/DamageRing/background.png', state=uiconst.UI_DISABLED, align=uiconst.CENTER)
