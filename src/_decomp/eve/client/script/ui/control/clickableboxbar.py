#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\control\clickableboxbar.py
import localization
from carbonui import uiconst
from carbonui.primitives.container import Container
from carbonui.primitives.fill import Fill

class ClickableBoxBar(Container):
    ...
    def ApplyAttributes(self, attributes):
        ...
        Fill(parent=self, color=bgColor)
    ...
    def CreateBox(self, boxIndex, colors, clickable, initialState, subHint):
        ...
        newBox = ClickableBoxBarBox(name='box', parent=self, align=uiconst.TOPLEFT, left=boxLeft, top=self.boxMargin, height=self.boxHeight, width=self.boxWidth, state=uiconst.UI_NORMAL)
...
class ClickableBoxBarBox(Container):
    ...
    def SetupUIElements(self):
        self.sr.highlight = Fill(parent=self, color=(1.0, 1.0, 1.0, 0.4))
        self.sr.highlight.state = uiconst.UI_HIDDEN
        self.fill = Fill(parent=self, color=self.defaultColor)
