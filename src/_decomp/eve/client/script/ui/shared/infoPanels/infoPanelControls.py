#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\shared\infoPanels\infoPanelControls.py
...
class InfoPanelHeaderBackground(Container):
    ...
    def ApplyAttributes(self, attributes):
        ...
        self.shadow = Frame(bgParent=self, frameConst=FRAME_SOFTSHADE, color=(0,
         0,
         0,
         self.DEFAULT_SHADOW_OPACITY), padding=(-10, -10, -10, -10))

    def HideShadow(self):
        self.shadow.opacity = 0

    def ShowShadow(self):
        self.shadow.opacity = self.DEFAULT_SHADOW_OPACITY
