#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\shared\info\panels\panelSkinLicense.py
...
class PanelSkinLicense(Container):
    ...
    def Load(self):
        entries = []
        license = sm.GetService('cosmeticsSvc').GetStaticLicenseByID(self.typeID)
