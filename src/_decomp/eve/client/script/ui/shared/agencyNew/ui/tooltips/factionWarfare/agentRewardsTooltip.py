#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\shared\agencyNew\ui\tooltips\factionWarfare\agentRewardsTooltip.py
...
class FactionWarfareAgentRewardsTooltip(TooltipBaseWrapper):
    ...
    def CreateTooltip(self, parent, owner, idx):
        ...
        labelPath = 'UI/Agency/Tooltips/Encounters/FactionWarfare/Agents/AgentsRewards2'
        text = GetByLabel(labelPath)
        self.tooltipPanel.AddLabelMedium(text=text, wrapWidth=WRAP_WIDTH, state=uiconst.UI_NORMAL)
        self.tooltipPanel.AddSpacer(height=5)
        self.tooltipPanel.AddLabelMedium(text=GetByLabel('UI/Agency/Tooltips/Encounters/FactionWarfare/Agents/FactionStandingBoost'), wrapWidth=WRAP_WIDTH)
        self.tooltipPanel.AddSpacer(height=5)
