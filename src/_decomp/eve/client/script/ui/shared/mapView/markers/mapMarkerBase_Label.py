#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\shared\mapView\markers\mapMarkerBase_Label.py
...
class MarkerLabelBase(MarkerUniverseBased):
    ...
    def __init__(self, *args, **kwargs):
        MarkerUniverseBased.__init__(self, *args, **kwargs)
