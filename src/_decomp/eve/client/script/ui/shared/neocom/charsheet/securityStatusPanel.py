...
from eve.client.script.ui.shared.standings.transaction import StandingTransaction
...
class SecurityStatusPanel(Container):
    ...
    def LoadPanel(self, *args):
        ...
        for transaction in data:
            ...
            entry = GetFromClass(StandingTransaction, {'sort_%s' % GetByLabel('UI/Common/Date'): transaction.eventDate,
