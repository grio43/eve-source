...
class CombatLogPanel(Container):
    ...
    def ApplyAttributes(self, attributes):
        ...
        self.combatCombo = Combo(parent=self.topCont, name='combo', select=selectedCombatType, align=uiconst.TOPLEFT, left=1, callback=self.OnCombatChange, options=combatValues, idx=0, adjustWidth=True, uniqueUiName=pConst.UNIQUE_NAME_SHOW_KILLS_LOSSES)
        self.sr.combatSetting = Checkbox(parent=self.topCont, align=uiconst.TOPLEFT, pos=(0,
         ...
         300,
         14), settingsKey='charsheet_condensedcombatlog', text=GetByLabel('UI/CharacterSheet/CharacterSheetWindow/KillsTabs/CondensedCombatLog'), checked=settings.user.ui.Get('charsheet_condensedcombatlog', 0), callback=self.CheckBoxChange)
        ...
        Button(parent=self.btnContainer, align=uiconst.CENTERRIGHT, left=4, texturePath='res:/UI/Texture/Icons/23_64_2.png', iconSize=24, hint=GetByLabel('UI/CharacterSheet/CharacterSheetWindow/KillsTabs/ViewMore'))
        Button(parent=self.btnContainer, align=uiconst.CENTERLEFT, left=4, texturePath='res:/UI/Texture/Icons/23_64_1.png', iconSize=24, hint=GetByLabel('UI/CharacterSheet/CharacterSheetWindow/KillsTabs/ViewPrevious'))
