#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\shared\neocom\wallet\panels\corp\corpBillsAutoPaidPanel.py
...
class CorpBillsAutoPaidPanel(Container):
    default_name = 'CorpBillsPayablePanel'
    __notifyevents__ = ['OnCorpWalletBillsChanged']

    def ApplyAttributes(self, attributes):
        super(CorpBillsAutoPaidPanel, self).ApplyAttributes(attributes)
        sm.RegisterNotify(self)
        ButtonGroup(btns=[(GetByLabel('UI/Wallet/WalletWindow/PayBill'),
          self.PayBillClick,
          (),
          84)], parent=self)
