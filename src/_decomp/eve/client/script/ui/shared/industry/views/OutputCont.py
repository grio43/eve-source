#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\shared\industry\views\OutputCont.py
from math import pi
import blue
...
from eve.client.script.ui.shared.industry.views.industryTooltips import CostContainerTooltipPanel, TimeContainerTooltipPanel
...
from uihighlighting.uniqueNameConst import UNIQUE_NAME_INDUSTRY_OUTPUT, UNIQUE_NAME_INDUSTRY_INPUT
...
class OutputCont(Container):
    ...
    def ConstructCostAndTimeLabels(self):
        self.labelCont = Container(name='labelCont', parent=self, align=uiconst.BOTTOMRIGHT, pos=(13,
         7,
         304,
         HEIGHT_NORMAL), opacity=0.0)
        self.timeCont = TimeContainer(parent=self.labelCont, align=uiconst.TOLEFT_PROP, width=0.45, jobData=self.jobData)
        self.costCont = CostContainer(parent=self.labelCont, align=uiconst.TOLEFT_PROP, width=0.55, padLeft=2)
    ...
    def ConstructTop(self):
        ...
        self.invInputCont = InventoryInputContainer(parent=self.topCont, align=uiconst.BOTTOMRIGHT, opacity=0.0, uniqueUiName=UNIQUE_NAME_INDUSTRY_INPUT)
    ...
    def ConstructBottom(self):
        ...
        self.invOutputCont = InventoryOutputContainer(parent=self.bottomCont, align=uiconst.CENTERRIGHT, left=13, uniqueUiName=UNIQUE_NAME_INDUSTRY_OUTPUT)
...
class CostContainer(Container):
    ...
    def ApplyAttributes(self, attributes):
        ...
        self.walletCombo = Combo(name='walletCombo', parent=textCont, align=uiconst.TOLEFT, state=uiconst.UI_HIDDEN, callback=self.OnWalletCombo, iconOnly=True, width=48, top=1)
    ...
    def GetWalletName(self, ownerID, divisionID):
        if ownerID == session.charid:
            ...
            divisionName = walletUtil.GetDivisionName(divisionID)
