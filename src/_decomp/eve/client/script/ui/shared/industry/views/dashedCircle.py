#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\shared\industry\views\dashedCircle.py
...
from eve.client.script.ui.shared.industry.industryUIConst import OPACITY_LINES, OPACITY_SEGMENTINCOMPLETE
...
class DashedCircle(Container):
    ...
    def ConstructSegments(self):
        ...
        for i in xrange(self.numSegments):
            line = VectorLineTrace(name='line', parent=self.segmentTransform, lineWidth=self.lineWidth, width=100, height=100, state=uiconst.UI_DISABLED)
