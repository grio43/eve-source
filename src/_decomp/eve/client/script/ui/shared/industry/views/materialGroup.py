#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\shared\industry\views\materialGroup.py
...
class MaterialGroup(Container):
    ...
    def GetNumPerRow(self):
        ...
        if self.numRows >= 2:
            if numMaterials > 3:
                return min(MAX_MATERIAL_PER_ROW, int(ceil(numMaterials / 2.0)))
        return numMaterials
