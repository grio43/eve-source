#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\shared\assets\assetSafetyDeliverWindow.py
...
class AssetSafetyDeliverWindow(Window):
    ...
    def SetText(self, systemStations):
        ...
        nearestNPCStationText = GetShowInfoLink(self.nearestNPCStationInfo['typeID'], stationName, nearestItemID)
