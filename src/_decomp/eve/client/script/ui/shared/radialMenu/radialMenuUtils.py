#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\shared\radialMenu\radialMenuUtils.py
import utillib

class SimpleRadialMenuAction(utillib.KeyVal):
...
class RangeRadialMenuAction(utillib.KeyVal):
...
class SecondLevelRadialMenuAction(utillib.KeyVal):
