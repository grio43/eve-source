#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\shared\radialMenu\inventoryRadialMenuFunctions.py
...
asteroidMapping.update({1: SimpleRadialMenuAction(option1='UI/Inventory/ItemActions/Reprocess')})
...
droneMapping.update({1: SimpleRadialMenuAction(option1='UI/Drones/LaunchDrone'),
 3: SecondLevelRadialMenuAction(hasExtraOptions=True, levelType='rework')})
...
def FindRadialMenuOptions(itemID = None, typeID = None, primaryActions = True, manyItemsData = None, rec = None, levelType = None):
    filterList = []
    allMenuOptions = GetMenuService().InvItemMenu(rec)
