#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\shared\vgs\views\pickOffer.py
    ...
    def _SortOffers(self, offers):
        ...
        def sortKey(offer):
            ...
            for pricing in offer.offerPricings:
                if pricing.currency == OFFER_CURRENCY_PLEX:
                    plexPrice = pricing.price

            return (offer.label is not None, plexPrice, offer.name)
...
class OfferEntry(ContainerAutoSize):
    ...
    def ApplyAttributes(self, attributes):
        ...
        OfferProductList(parent=self, align=uiconst.TOTOP, padding=(self.PADDING,
         0,
         self.PADDING,
         self.PADDING), iconSize=32, products=self.offer.productQuantities.values())
