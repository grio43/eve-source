#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\shared\vgs\loading.py
from carbonui import const as uiconst
from carbonui.primitives.container import Container
from carbonui.primitives.containerAutoSize import ContainerAutoSize
from carbonui.primitives.sprite import Sprite
from eve.client.script.ui.control.eveLoadingWheel import LoadingWheel
from eve.client.script.ui.shared.vgs.label import VgsLabelLarge, VgsLabelSmall, VgsLabelMedium
...
class VgsLoadingPanel(Container):
    ...
    def ApplyAttributes(self, attributes):
        ...
        labelClass = attributes.get('labelClass', VgsLabelLarge)
        ...
        labelClass(parent=labelWrap, align=uiconst.CENTER, text=text)
