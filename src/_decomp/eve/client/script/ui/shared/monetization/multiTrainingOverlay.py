#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\shared\monetization\multiTrainingOverlay.py
...
class MultiTrainingOverlay(Container):
    SUPPRESS_KEY = 'suppress.' + localization.GetByLabel('UI/SkillQueue/MultiTrainingOverlay/MultiplePilotTraining')
    CONTENT_LEFT = 140
    CHARACTERS_LEFT = -180
    ...
    def Layout(self):
        ...
        InfoIcon(parent=itemCont, align=uiconst.TOPRIGHT, top=8, typeID=typeMultiTrainingToken)
    ...
    def ShouldDisplay(self):
        ...
        if sm.GetService('skillqueue').SkillInTraining() is not None:
            return False
        return sm.GetService('skillqueue').IsAllCharacterTrainingSlotsUsed()
