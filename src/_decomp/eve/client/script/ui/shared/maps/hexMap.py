#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\shared\maps\hexMap.py
import math
import localization
import trinity
from eve.client.script.ui.shared.maps.mapcommon import LegendItem, COLOR_STANDINGS_BAD, COLOR_STANDINGS_GOOD, COLOR_STANDINGS_NEUTRAL
...
class HexMapController(object):
    ...
    def SetupScene(self):
        ...
        curve.AddKey(1.0, 1.0)
        curve.AddKey(2.0, 0.0)
