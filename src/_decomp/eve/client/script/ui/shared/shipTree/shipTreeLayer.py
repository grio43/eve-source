#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\shared\shipTree\shipTreeLayer.py
...
class ShipTreeLayer(LayerCore):
    ...
    def OnOpenView(self, **kwargs):
        ...
        self.factionID = kwargs.get('factionID', None)
