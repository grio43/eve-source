#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\hacking\hackingUtilityElement.py
import localization
...
class UtilityElement(Container):
    ...
    def ApplyAttributes(self, attributes):
        ...
        self.mouseDownSprite = Sprite(name='mouseDownSprite', bgParent=self, texturePath='res:/UI/Texture/classes/hacking/utilTileMouseDown.png', opacity=0.0, padding=-15)
        self.mouseHoverSprite = Sprite(name='mouseHoverSprite', bgParent=self, texturePath='res:/UI/Texture/classes/hacking/utilTileMouseHover.png', opacity=0.0, padding=-15)
        Sprite(name='baseSprite', bgParent=self, texturePath='res:/UI/Texture/classes/hacking/utilTileBase.png', padding=-15)
        self.iconSprite = Sprite(parent=self, align=uiconst.CENTER, pos=(0, 0, 64, 64), state=uiconst.UI_DISABLED)
        self.durationLabel = eveLabel.Label(name='durationLabel', parent=self, align=uiconst.CENTERTOP, top=-10, bold=True)
