#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\graphs\bargraph.py
...
class BarGraphBarBase(Container):
    ...
    def UpdateUIScaling(self, value, oldValue):
        super(BarGraphBarBase, self).UpdateUIScaling(value, oldValue)
        self.ReloadGraph()
