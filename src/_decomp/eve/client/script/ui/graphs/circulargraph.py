#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\graphs\circulargraph.py
import carbonui.const as uiconst
from carbonui.primitives.container import Container
from carbonui.primitives.sprite import Sprite, VisibleBase
...
class CircularGraph(Container):
    ...
    default_colorBg = (1.0, 1.0, 1.0, 0.1)
    ...
    def CreateLineTrace(self, color, lineWidth):
        ...
        outputMode = VisibleBase.default_outputMode
        if self.glow:
            outputMode = uiconst.OUTPUT_COLOR_AND_GLOW
        line = CircularGraphSegment(name='segmentline', parent=self, lineWidth=lineWidth, width=graphSize, height=graphSize, color=color, state=uiconst.UI_NORMAL, outputMode=outputMode, glowBrightness=self.glowBrightness)
        line.end = 0.0
