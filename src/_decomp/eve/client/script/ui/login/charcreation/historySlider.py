#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\login\charcreation\historySlider.py
    ...
    def SettleScrollHandle(self, initing = False):
        if self._lastLit is not None:
            ...
            if not initing:
                ...
                uthread.new(uicore.layer.charactercreation.controller.LoadDnaFromHistory, self._lastLit.idx)
