#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\login\charcreation\steps\characterPortrait.py
...
class CharacterPortrait(BaseCharacterCreationStep):
    ...
    def ReloadPortraits(self):
        ...
        for i in xrange(ccConst.NUM_PORTRAITS):
            if uicore.layer.charactercreation.controller.facePortraits[i] is not None:
                photo = uicore.layer.charactercreation.controller.facePortraits[i]
                ...
                if photo == uicore.layer.charactercreation.controller.activePortrait:
    ...
    def SetPortraitFocus(self, selectedNo, *args):
        ...
        uicore.layer.charactercreation.controller.SetActivePortrait(selectedNo)

    def ValidateStepComplete(self):
        if not self.IsDollReady:
            return False
        if uicore.layer.charactercreation.controller.GetPortraitInfo(self.selectedPortrait) is None:
    ...
    def CapturePortrait(self, idx, *args):
        ...
        if photo:
            ...
            uicore.layer.charactercreation.controller.SetFacePortrait(photo, idx)
