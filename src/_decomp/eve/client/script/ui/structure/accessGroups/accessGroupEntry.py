#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\structure\accessGroups\accessGroupEntry.py
import carbonui
...
class AccessGroupEntry(MouseInsideScrollEntry):
    ...
    def Load(self, node):
        ...
        self.groupNameLabel.text = node.get('groupDisplayName', None) or groupInfo.name
