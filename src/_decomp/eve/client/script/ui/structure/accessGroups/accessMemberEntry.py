#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\structure\accessGroups\accessMemberEntry.py
import carbonui
from carbon.client.script.environment.AudioUtil import PlaySound
from carbonui.control.contextMenu import contextMenu
...
class AccessMemberEntry(MouseInsideScrollEntry):
    ...
    def Load(self, node):
        ...
        if membershipType == MEMBERSHIP_TYPE_MEMBER:
            ...
            accessTexturePath, hintPath, textureSize = GetMembershipTypeTextureAndLabelPaths(membershipType)
            self.membershipTypeSprite.texturePath = accessTexturePath
            self.membershipTypeSprite.SetSize(*textureSize)
    ...
    def GetOwnerFlagInfo(self, ownerInfo):
        ...
        flag, _ = GetRelationShipFlag(charID, corpID, allianceID)
