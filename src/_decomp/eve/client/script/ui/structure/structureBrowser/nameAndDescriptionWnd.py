#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\structure\structureBrowser\nameAndDescriptionWnd.py
...
class CreateProfileWnd(NameAndDescBaseWnd):
    ...
    def Confirm(self, name, desc):
        ...
        fullProfileController = StructureProfileController(profileID, profileInfo=slimProfileController.GetProfileInfo())
