#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\station\lpstoreRequirement.py
...
class EMRequirement(LpStoreRequirement):
    LP_REQUIREMENT_NAME = 'lpCost'
    LP_AMOUNT_NAME = 'lpAmount'
    LP_AMOUNT_HINT_PATH = 'UI/LPStore/AmountEM'
    LP_NOT_FULFILLED_HINT_PATH = 'UI/LPStore/HintInsufficientEMs'
    LP_COST_LABEL_PATH = 'UI/LPStore/EMCost'
    LP_PRICE_LABEL_PATH = 'UI/LPStore/PriceInEM'
