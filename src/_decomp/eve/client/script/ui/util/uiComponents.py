#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\util\uiComponents.py
import functools
import math
import signals
...
class ButtonEffect:
    ...
    def OnClick(self, _self, *args):
        ...
        self.Toggle(_self)
        if not self.IsActiveToggle(_self):
            uicore.animations.FadeTo(_self._buttonEffect_bgElement, _self._buttonEffect_bgElement.opacity, self.opacityMouseDown, duration=self.exitDuration)
