#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\ui\podGuide\megaMenuEntries.py
...
class MegaMenuEntry(Container):
    ...
    def OnMouseEnter(self, *args):
        ...
        self.textLabel.SetRGBA(1, 0, 0, 1)

    def OnMouseExit(self, *args):
        self.hiliteFill.opacity = 0.0
        self.textLabel.SetRGBA(1, 1, 1, 1)
