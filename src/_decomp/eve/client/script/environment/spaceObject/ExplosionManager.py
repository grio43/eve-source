#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\environment\spaceObject\ExplosionManager.py
...
class PooledExplosion:
    ...
    def __init__(self, path):
        ...
        self.boundingSphereRadius = self.pool[0].boundingSphereRadius
...
class ExplosionManager(object):
    ...
    def GetBoundingSphereRadius(self, path):
        if path not in self.pooledExplosions:
            ...
            self.Preload(path, count=0)
        return self.pooledExplosions[path].boundingSphereRadius
