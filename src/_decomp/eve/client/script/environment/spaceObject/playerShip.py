#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\environment\spaceObject\playerShip.py
import trinity
import math
...
class PlayerShip(Ship):
    ...
    def OnSubSystemChanged(self, newSlim):
        Ship.OnSubSystemChanged(self, newSlim)
        self._Update()
    ...
    def IsLookedAt(self):
        return self.id == self.sm.GetService('stateSvc').GetExclState(lookingAt)
