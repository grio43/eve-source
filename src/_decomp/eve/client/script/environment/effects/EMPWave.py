#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\environment\effects\EMPWave.py
...
class EMPWave(GenericEffect):
    ...
    def Prepare(self):
        ...
        if self.graphicInfo is not None and self.graphicInfo.graphicID:
            graphicID = self.graphicInfo.graphicID
