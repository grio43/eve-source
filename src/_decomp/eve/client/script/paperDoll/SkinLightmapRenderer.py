#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\eve\client\script\paperDoll\SkinLightmapRenderer.py
import trinity
import blue
import telemetry
import weakref
...
class SkinLightmapRenderer:
    ...
    def DuplicateEffect(fx, newPath, dupResources = True):
        ...
        newEffect.parameters.extend(fx.parameters)
    ...
    def AddMesh(self, mesh):
        ...
        for areaRef, fx in m.origEffect.iteritems():
            ...
            stretchmapRenderEffect.parameters.extend(fx.parameters)
            ...
            lightmapApplyEffect.RebuildCachedData()
            if False:
