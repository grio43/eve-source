#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\future\backports\http\client.py
...
class HTTPResponse(io.RawIOBase):
    ...
    def _check_close(self):
        ...
        if pconn and u'keep-alive' in pconn.lower():
            return False
        return True
