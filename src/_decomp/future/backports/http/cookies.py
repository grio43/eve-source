#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\future\backports\http\cookies.py
...
class Morsel(dict):
    ...
    def OutputString(self, attrs = None):
        ...
        for key, value in items:
            ...
            elif key == u'max-age' and isinstance(value, int):
