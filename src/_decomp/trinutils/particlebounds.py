#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\trinutils\particlebounds.py
import logging
...
class ParticleBoundsSimulation(object):
    ...
    def _EnableParticleSorting(self):
        for ps in self.systems:
            ps.requiresSorting = True
    ...
    def RunSimulation(self):
        ...
        trinity.settings.SetValue('eveSpaceSceneLODFactor', 0)
