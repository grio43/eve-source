#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\carbonui\camera\polarCamera.py
import blue
import math
import geo2
import trinity
from carbon.common.lib.const import SEC
from carbon.common.script.util import mathCommon, mathUtil
from carbon.common.script.util.timerstuff import AutoTimer
from carbonui.camera.basicCamera import BasicCamera

class PolarCamera(BasicCamera):

    def __init__(self):
        BasicCamera.__init__(self)
        self.poi = (0, 0, 0)
    ...
    def _AssembleViewMatrix(self, cameraPOI, yaw, pitch, dist):
        ...
        matrix = mathCommon.ConvertTriToTupleMatrix(self.CreateViewMatrix(camera_location, (camera_yaw, camera_pitch, camera_roll)))
    ...
    def Update(self):
        ...
        frameTime = float(now - self.lastUpdateTime) / SEC
        self.poiModifier = (0, 0, 0)
