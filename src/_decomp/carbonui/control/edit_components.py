#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\carbonui\control\edit_components.py
import sys
import _weakref
import blue
import uthread
...
class Cell(ParserBase, SE_BaseClassCore):
    ...
    def VAlignContent(self):
        if not self or self.destroyed:
            return
        s = self.celldata.styles
        if s['vertical-align'] == parser.ALIGNMIDDLE:
        ...
        elif s['vertical-align'] == parser.ALIGNBOTTOM:
        ...
        elif s['vertical-align'] == parser.ALIGNTOP:
