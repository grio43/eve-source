#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\carbonui\control\editutils\parser.py
from carbonui.control.editutils import htmlscraper
import _weakref
...
class Parser(htmlscraper.HtmlScraper):
