#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\carbonui\control\image.py
...
class ImageCore(Container):
    ...
    def OnClick(self, *args):
        if self.IsClickable():
            ...
            Link().ClickLink(self, self.attrs.a.href.replace('&amp;', '&'))
    ...
    def IsClickable(self):
        return getattr(self.attrs, 'a', None)
