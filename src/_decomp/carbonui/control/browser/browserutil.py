#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\carbonui\control\browser\browserutil.py
import blue
import urllib2
import urllib
import urlparse
...
class NewBrowserForm():
    ...
    def Create_text(self, attrs):
        ...
        wnd = SingleLineEditText(name='textedit', align=uiconst.RELATIVE, pos=(0,
         0,
