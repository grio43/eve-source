#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\carbonui\graphs\minmaxareagraph.py
...
class MinMaxAreaGraph(Polygon):
    default_name = 'MinMaxAreaGraph'
    ...
    def Close(self):
        ...
        super(MinMaxAreaGraph, self).Close()
    ...
    def _Build(self):
        ...
        self.AppendVertices(positions, self._GetTransform(), self.graphColor)
        triangles = []
        for i in xrange(len(self._categoryAxis.GetDataPoints()) - 1):
            i2 = i * 2
