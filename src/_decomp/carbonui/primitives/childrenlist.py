#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\carbonui\primitives\childrenlist.py
import weakref
from carbonui.primitives.base import Base

class PyChildrenList(object):

    def __init__(self, owner, children = None):
        if children is None:
            children = []
        self._childrenObjects = children
