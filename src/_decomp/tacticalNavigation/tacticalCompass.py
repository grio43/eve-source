#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\tacticalNavigation\tacticalCompass.py
...
import trinity
import math
import tacticalNavigation.ui.util as navUI
...
class TacticalCompass:
    ...
    def __init__(self):
        ...
        self.sceneManager.RegisterPersistentUIObject(self.rootPersistenceKey, self.rootTransform)
        ...
        self.sceneManager.RegisterPersistentUIObject(self.connectorPersistenceKey, self.connectorContainer)
        ...
        self.sceneManager.RegisterPersistentUIObject(self.bombSpherePersistanceKey, self.bombSphere)
        ...
        self.sceneManager.RegisterPersistentUIObject(self.firingRangePersistenceKey, self.firingRangeRoot)
        ...
        self.sceneManager.RegisterPersistentUIObject(self.darkDiscPersistenceKey, self.darkDiscContainer)
        self.connectors = {}
        self.selection = None
    ...
    def AddConnector(self, ball, showVelocity = True):
        ...
        trackObject.showVelocity = showVelocity
    ...
    def HasConnector(self, ballID):
        return ballID in self.connectors
    ...
    def ClearAll(self):
        ...
        self.sceneManager.RemovePersistentUIObject(self.rootPersistenceKey)
        self.rootTransform = None
        self.sceneManager.RemovePersistentUIObject(self.connectorPersistenceKey)
        self.connectorContainer = None
        self.sceneManager.RemovePersistentUIObject(self.firingRangePersistenceKey)
        self.firingRangeRoot = None
        self.sceneManager.RemovePersistentUIObject(self.bombSpherePersistanceKey)
        self.bombSphere.translationCurve = None
        self.bombSphere = None
        self.sceneManager.RemovePersistentUIObject(self.darkDiscPersistenceKey)
