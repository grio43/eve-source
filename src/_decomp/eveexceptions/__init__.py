#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\eveexceptions\__init__.py
from eveexceptions.const import *
from eveexceptions.exceptionEater import ExceptionEater, EatsExceptions
import __builtin__
import types
...
class CancelSessionChange(UserError):
    pass
...
class UnmarshalError(StandardError):
    __guid__ = 'exceptions.UnmarshalError'
