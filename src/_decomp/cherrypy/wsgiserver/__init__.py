#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\carbon\common\lib\cherrypy\wsgiserver\__init__.py
CRLF = '\r\n'
import os
import Queue
import re
...
try:
    ...
    try:
        ...
        _SetHandleInformation = kernel32.SetHandleInformation
        _SetHandleInformation.argtypes = [ctypes.wintypes.HANDLE, ctypes.wintypes.DWORD, ctypes.wintypes.DWORD]
