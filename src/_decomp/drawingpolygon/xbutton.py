#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\drawingpolygon\xbutton.py
...
class XButton(Container):
    ...
    def setup_x_area(self):
        x_area = Container(name='x_area', parent=self, align=uiconst.TOLEFT, width=ICON_SIZE, state=uiconst.UI_DISABLED)
        self.x_sprite = Sprite(name='x_sprite', parent=x_area, align=uiconst.CENTER, width=ICON_SIZE, height=ICON_SIZE, texturePath=TEXTURE_X, color=BLUE_COLOR)
        self.black_circle = Sprite(name='black_circle', parent=x_area, align=uiconst.CENTER, width=ICON_SIZE, height=ICON_SIZE, texturePath=TEXTURE_BLACK_CIRCLE)
        self.blue_circle = Sprite(name='blue_circle', parent=x_area, align=uiconst.CENTER, width=ICON_SIZE, height=ICON_SIZE, texturePath=TEXTURE_BLUE_CIRCLE)
        self.white_ring = Sprite(name='white_ring', parent=x_area, align=uiconst.CENTER, width=ICON_SIZE, height=ICON_SIZE, texturePath=TEXTURE_WHITE_RING, opacity=0.0)

    def setup_tooltip_area(self):
        tooltip_area = Container(name='tooltip_area', parent=self, align=uiconst.TOLEFT, width=CLEAR_WIDTH, state=uiconst.UI_DISABLED, padLeft=PADDING_ICON_TO_CLEAR)
        self.clear_tooltip = Sprite(name='clear_tooltip', parent=tooltip_area, align=uiconst.CENTER, width=CLEAR_WIDTH, height=CLEAR_HEIGHT, texturePath=TEXTURE_CLEAR, opacity=0.0)
