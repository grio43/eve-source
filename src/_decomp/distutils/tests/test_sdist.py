#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\carbon\common\stdlib\distutils\tests\test_sdist.py
import os
import unittest
import shutil
import zipfile
...
class SDistTestCase(PyPIRCCommandTestCase):
    ...
    def test_add_defaults(self):
        ...
        dist.data_files = [('data', ['data/data.dt', 'inroot.txt', 'notexisting']), 'some/file.txt', 'some/other_file.txt']
