#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\evecamera\utils.py
import blue
import evecamera
...
def CreateBehaviorFromMagnitudeAndPosition(magnitude, shakeOrigin, camera):
    ...
    noiseScaleCurve.AddKey(0.0, 1.2 * actualMagnitude, trinity.Tr2CurveInterpolation.HERMITE, 0.0, 0.0, trinity.Tr2CurveTangentType.FREE_SPLIT)
    noiseScaleCurve.AddKey(0.1, 0.1 * actualMagnitude, trinity.Tr2CurveInterpolation.HERMITE, 0.0, 0.0, trinity.Tr2CurveTangentType.FREE_SPLIT)
    noiseScaleCurve.AddKey(1.5 * timeFactor, 0.13 * actualMagnitude, trinity.Tr2CurveInterpolation.HERMITE, 0.0, 0.0, trinity.Tr2CurveTangentType.FREE_SPLIT)
    noiseScaleCurve.AddKey(2.0 * timeFactor, 0.0 * actualMagnitude, trinity.Tr2CurveInterpolation.HERMITE, 0.0, 0.0, trinity.Tr2CurveTangentType.FREE_SPLIT)
    if camera.noiseScaleCurve is not None and camera.noiseScaleCurve.currentValue > noiseScaleCurve.keys[1][1]:
        return
    noiseDampCurve = trinity.Tr2CurveScalar()
    noiseDampCurve.AddKey(0.0, 80.0 * actualMagnitude, trinity.Tr2CurveInterpolation.HERMITE, 0.0, 0.0, trinity.Tr2CurveTangentType.FREE_SPLIT)
    noiseDampCurve.AddKey(0.1, 20.0 * actualMagnitude, trinity.Tr2CurveInterpolation.HERMITE, 0.0, 0.0, trinity.Tr2CurveTangentType.FREE_SPLIT)
    noiseDampCurve.AddKey(1.5 * timeFactor, 0.0, trinity.Tr2CurveInterpolation.HERMITE, 0.0, 0.0, trinity.Tr2CurveTangentType.FREE_SPLIT)
    noiseDampCurve.AddKey(2.0 * timeFactor, 0.0, trinity.Tr2CurveInterpolation.HERMITE, 0.0, 0.0, trinity.Tr2CurveTangentType.FREE_SPLIT)
