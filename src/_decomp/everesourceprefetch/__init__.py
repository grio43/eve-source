#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\everesourceprefetch\__init__.py
import blue
...
FILESET_DEFINITIONS = [('staticdata', ['res:/staticdata'], ALL_FILES),
 ...
 ('low_detail_nebulas', ['res:/dx9/scene'], lambda x: '_lowdetail.' in x),
