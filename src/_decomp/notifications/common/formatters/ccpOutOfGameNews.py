#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\notifications\common\formatters\ccpOutOfGameNews.py
from baseFormatter import BaseNotificationFormatter

class CCPOutOfGameNewsFormatter(BaseNotificationFormatter):

    def __init__(self, subjectLabel = None, bodyLabel = None, subtextLabel = None):
        super(CCPOutOfGameNewsFormatter, self).__init__()
