...
EVENT_TYPE_TO_ACTION = {const.skillEventClonePenalty: localization.GetByLabel('UI/CharacterSheet/CharacterSheetWindow/SkillTabs/SkillClonePenalty'),
 ...
 const.skillEventGift: localization.GetByLabel('UI/CharacterSheet/CharacterSheetWindow/SkillTabs/SkillGift')}
DEFAULT_ACTION = localization.GetByLabel('UI/Generic/Unknown')
...
class SkillHistoryProvider(object):
    ...
    def provide(self):
        ...
        for row in skillRowSet:
            ...
            if skill is None:
                continue
            objectRow = SkillHistoryRow(row, skill.skillRank, cfg, EVENT_TYPE_TO_ACTION, DEFAULT_ACTION)
