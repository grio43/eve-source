#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\beeline\patch\requests.py
import beeline
...
def request(_request, instance, args, kwargs):
    ...
    if b and b.http_trace_propagation_hook is not None:
        ...
        if new_headers:
            b.log('requests lib - adding trace context to outbound request: %s', new_headers)
    ...
    try:
        ...
        beeline.add_context({'name': 'requests_%s' % method,
