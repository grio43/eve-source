#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\pytelemetry\dumpmanager.py
import os
import sys
import shutil
import time
...
TELEMETRY_DUMP_FILENAME = 'tmdata.tmcap'

def is_telemetry_file(f):
    return f == TELEMETRY_DUMP_FILENAME
