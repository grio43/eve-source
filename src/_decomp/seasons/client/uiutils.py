#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\seasons\client\uiutils.py
...
PROGRESS_BAR_COLOR = (0.22, 0.3, 0.34, 1)
...
SEASON_DEFAULT_BORDER_LINE_COLOR = (118 / 255.0,
 ...
 255 / 255.0,
 0.7)
SEASON_FRAME_BACKGROUND_FILL_COLOR = (0, 0, 0, 0.5)
SEASON_THEME_TEXT_COLOR_HIGHLIGHTED = (1, 1, 1, 1)
SEASON_THEME_TEXT_COLOR_REGULAR = (1, 1, 1, 1.0)
...
CHALLENGE_BACKGROUND_COLOR_ACTIVE = (1.0, 1.0, 1.0, 0.05)
...
def get_reward_icon_in_size(reward_type_id, size, name, parent, align, padding = 0):
    ...
    reward_icon_texture = GetIconFile(icon_id)
