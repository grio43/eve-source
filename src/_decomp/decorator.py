#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\carbon\common\stdlib\decorator.py
...
def decorate(func, caller, extras = ()):
    ...
    if generatorcaller:
        fun = FunctionMaker.create(func, 'for res in _call_(_func_, %s%%(shortsignature)s):\n    yield res' % es, evaldict, __wrapped__=func)
    else:
