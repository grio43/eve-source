#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\achievements\common\util.py
from collections import defaultdict
from achievements.common.opportunityTaskMap import BuildIndex
import gametime
ARE_OPPORTUNITIES_ENABLED = False

def AreOpportunitiesEnabled():
    return ARE_OPPORTUNITIES_ENABLED
