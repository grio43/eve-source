#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\evegraphics\ui\lineController.py
import trinity
...
class LineController:
    ...
    def __init__(self, scene = None):
        ...
        if scene is not None:
            ...
            sm.GetService('sceneManager').RegisterPersistentUIObject((LineController, 0), self._connectorContainer)
            sm.GetService('sceneManager').RegisterPersistentUIObject((LineController, 1), self._freeformLineSet)
