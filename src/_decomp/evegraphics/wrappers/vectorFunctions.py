#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\evegraphics\wrappers\vectorFunctions.py
import blue
import geo2
import trinity
...
class XZProjectionFunction(VectorFunction):
    ...
    def __init__(self, positionFunction, planeY = 0):
        ...
        self.projectionCurve = trinity.Tr2TranslationAdapter()
