#Embedded file name: C:\BuildAgent\work\ba3dced9a47cf95a\eve\release\V22.02\packages\evegraphics\wrappers\transformLabel.py
import trinity
...
class TransformableLabel(object):
    ...
    def __init__(self, text, parent, size = 72, shadow = 0, hspace = 8, font = None):
        ...
        self.effect.options.append(('DEPTH_MAP_OCCLUSION', 'DEPTH_MAP_OCCLUSION_YES'))
